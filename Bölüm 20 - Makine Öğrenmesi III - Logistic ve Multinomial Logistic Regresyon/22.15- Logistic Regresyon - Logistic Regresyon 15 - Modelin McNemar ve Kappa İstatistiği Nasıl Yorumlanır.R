...
cbind(predicted = as.character(predictedClass) , actulas = as.character(testSet$status))
...
## Mcnemar p-value > 0.05 False Positive ve False Negative birbirine benzerdir. 
